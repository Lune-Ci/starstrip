    ...
    <div className="max-w-2xl mx-auto">
      <Card className="liquid-glass border-0 p-6 md:p-12">
        <div className="flex items-center gap-3 md:gap-4 mb-6">
          ...
          <div>
            <h2 className="text-xl md:text-3xl font-bold text-[#1a3a52]">
              {t.whereAreYouStartingFrom}
            </h2>
            <p className="text-sm md:text-base text-[#4a6b84] mt-1">
              {t.selectYourStartingCityInChina}
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <Label
            htmlFor="location"
            className="text-base md:text-lg text-[#1a3a52]"
          >
            {t.startingLocation}
          </Label>
          <Select value={startLocation} onValueChange={onLocationChange}>
            <SelectTrigger
              id="location"
              className="w-full h-12 md:h-14 bg-white/60 text-base md:text-lg"
            >
